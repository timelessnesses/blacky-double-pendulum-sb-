...
namespace StorybrewScripts
{
    ...
    public class Spectrum : StoryboardObjectGenerator
    {
        ...
        public override void Generate()
        {
            ...
            {
                GenerateSpectrum(kvp.Key, kvp.Value);
            }
        }
        public void GenerateSpectrum(int StartTime, int EndTime)
        {
            ...
            for (var i = 0; i < BarCount; i++)
            {
                ...
                bar.ColorHsb(StartTime, 173 + Random(-10.0, 10.0), 0.6 + Random(0.4), 1);
                bar.Fade(StartTime-1, StartTime, 0, 1);
                bar.Fade(EndTime, EndTime + 1, 1, 0);
